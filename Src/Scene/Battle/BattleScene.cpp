...

	{
...

		{
...

			{
				...
				// 必要に応じて SceneManager::GetInstance().ChangeScene(SceneManager::SCENE_ID::RESULT); などを実行
...

{
	...
	case END_REWARD::SKILL:
		...
		// SceneManager::GetInstance().GetPlayer()->AddItem(ItemID::POTION);
